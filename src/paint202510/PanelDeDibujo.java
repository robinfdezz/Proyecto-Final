...
public class PanelDeDibujo extends JPanel {
    ...
    private Figura obtenerFiguraADibujar(Point punto) {
        ...
        } else if (barraDeHerramientas.btnCuadrado.isSelected()) {
            return new Cuadrado(punto);
        } else if (barraDeHerramientas.btnTriangulo.isSelected()) {
        ...
        } else if (barraDeHerramientas.btnCorazon.isSelected()){ // Añadido Corazon
